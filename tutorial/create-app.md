...
<span data-ttu-id="9229e-146">Затем замените имеющееся `home` представление следующим.</span><span class="sxs-lookup"><span data-stu-id="9229e-146">Then replace the existing `home` view with the following.</span></span>
