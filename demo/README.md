# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="88111-101">Выполнение завершенного проекта</span><span class="sxs-lookup"><span data-stu-id="88111-101">How to run the completed project</span></span>
